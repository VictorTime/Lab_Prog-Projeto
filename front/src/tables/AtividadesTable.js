	  ...
	  const row = props.atividades.map ( Atividades => {
	  	return(
             <tr key = {Atividades.id_atv}>
                        ...
                        <td>
                            <div class="btn-group">
                                <button onclick="window.location.href=&#39;#/atividade&#39;" type="button" class="btn btn-info">Adicionar Posição</button>
                                <button onclick="window.location.href=&#39;#/atividade&#39;" type="button" class="btn btn-warning">Editar</button>

...
//Aqui a gente coloca os botões da barra lateral
// O icone são colocados com o react-icons 
export const SidebarData = [
  ...
  /*
  {
    title: 'Usuarios',
    path: '/usuario',
    //Aqui é um exemplo de por o icone direto pelo svg, vc pode fazer isso com o react-icons
